...
5. Метод containsBones в классе Finger должен возвращать строку "Yes", если метод containsBones в классе
...
если метод containsBones возвращает "Yes" для этой части тела, а если "No", то строку формата
...
public class task344_lev15_lec02 {
