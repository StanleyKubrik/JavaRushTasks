 ...
 */
package javaSyntax.level9.stacktrace;

public class task200_lev9_lec02 {
    ...
    public static String method1() {
        method2();
        StackTraceElement[] stackTraceElements = Thread.currentThread().getStackTrace(); // создаём массив стека
        //for (int i = 0; i < stackTraceElements.length; i++) {
        //    System.out.println(stackTraceElements[i].getMethodName());
        //}
        System.out.println(stackTraceElements[2].getMethodName());
        return stackTraceElements[2].getMethodName();        // возвращаем main, который вызвал method1
    }
