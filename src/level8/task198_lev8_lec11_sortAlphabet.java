...
public class task198_lev8_lec11_sortAlphabet {
    ...
    public static boolean isGreaterThan(String a, String b) {   // вставлять нужно целые строки
        return a.compareTo(b) > 0;                              // если параметры a, b = false, если b, a = true
    }
}
